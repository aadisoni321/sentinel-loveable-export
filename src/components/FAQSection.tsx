  ...
  return (
    <section className="bg-pure-black py-[120px] overflow-hidden">
      ...
      <div className="relative space-y-6 w-full">
        ...
        {/* Fade Gradients */}
        <div className="absolute left-8 -top-8 -bottom-8 w-48 bg-gradient-to-r from-pure-black to-transparent pointer-events-none z-10"></div>
        <div className="absolute right-8 -top-8 -bottom-8 w-48 bg-gradient-to-l from-pure-black to-transparent pointer-events-none z-10"></div>
        </div>
    </section>
  );
};
