  ...
  return (
    <section className="bg-pure-black border-t border-white/10 py-20 px-4 md:px-8 lg:px-[120px]">
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-8">
        ...
        <div>
          <button className="bg-electric-blue text-pure-white px-36 py-3 text-lg font-semibold hover:bg-blue-hover hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-electric-blue/30">
            Get Sentinel →
          </button>
        </div>
      </div>
